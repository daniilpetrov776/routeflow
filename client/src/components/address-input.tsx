...
//       const suggestions: Suggestion[] = data.results?.map((item: any) => ({
//         title: item.title?.text || '',
//         subtitle: item.subtitle?.text || '',
//         coordinates: item.pos ? item.pos.split(' ').map(Number).reverse() : [0, 0]
//       })) || [];
...
//     // Save manually entered address even without suggestions
