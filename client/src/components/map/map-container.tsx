...
export function MapContainer({
  ...
  useEffect(() => {
    ...
    const recommendedRoute = routesRef.current.find((_, idx) => idx === recommendedRouteIndex);
    if (recommendedRoute) {
  ...
  }, [startingPoint, validDestinationsKey, transportMode, calculateRoutes, clearCalculatedRoutes]);
